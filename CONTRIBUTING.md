...
Follow the [README](README.md) for platform dependencies and startup. Use Node 22.12+ (22.x), npm 11 and stable Rust, matching CI.
...
Use Conventional Commits, for example `fix(library): preserve offline page selection`. Describe the user-visible result, scope and checks. Link implementation issues and close only work actually completed on main. An epic with unfinished children stays open.
