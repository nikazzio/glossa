...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            download::pdf::enqueue_pdf_download,
            download::pdf::document_bytes,
            download::pdf::open_document_externally,
            ...
            iiif::discovery::inspect_manifest,
            ...
            httpcache::commands::image_source,
            httpcache::commands::forget_version_cache,
