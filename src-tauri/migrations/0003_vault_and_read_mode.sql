...
--
-- Nota sul metodo: le tabelle prendono la forma finale subito, senza rattoppi,
-- ma ci si arriva con un file di migrazione per volta. Riscrivere 0001 a ogni
-- PR non si può: sqlx traccia le migrazioni applicate per checksum, quindi una
-- migrazione già applicata che cambia fa fallire l'avvio su ogni database
-- esistente. Il consolidamento in un'unica baseline pulita si fa una volta
-- sola, prima del primo uso reale (appendice di BLOCCO_1_DECISIONI.md).
