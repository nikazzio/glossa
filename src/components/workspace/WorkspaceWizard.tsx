  ...
  return (
    <div className="flex min-h-dvh min-h-[var(--app-min-height)] min-w-[var(--app-min-width)] flex-col items-center justify-center gap-6 p-8">
      ...
      <div className="flex w-full max-w-sm flex-col gap-4">
        ...
        <button
          type="button"
          className="rounded-full bg-editorial-ink px-5 py-3 text-xs font-bold uppercase tracking-[0.16em] text-white transition-colors hover:bg-editorial-ink/90 focus:outline-none focus-visible:ring-2 focus-visible:ring-editorial-accent disabled:opacity-35"
