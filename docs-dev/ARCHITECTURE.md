...
- **Colonna centro**: Vista documento (`DocumentView`) — barra navigazione fissa in alto (h-20, indicatori stadi + minimap frammenti a sinistra); i controlli frammento precedente/successivo sono stati spostati nella testata della rail sinistra (#296), non più nella testata centrale. Due pannelli bianchi a filo (Originale/Candidata).
